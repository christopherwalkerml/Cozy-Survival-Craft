...
StartupEvents.registry('item', event => {
	...
	event.create('mythril_sheet').texture("kubejs:item/mythril_sheet").displayName('Mythril Sheet').rarity('uncommon')
	event.create('mythril_ingot').texture("kubejs:item/mythril_ingot").displayName('Mythril Ingot').rarity('uncommon')
	...
	event.create('netherite_chunk').texture("kubejs:item/netherite_chunk").displayName('Netherite Chunk').rarity('uncommon')
	event.create('netherite_dust').texture("kubejs:item/netherite_dust").displayName('Netherite Dust')
	event.create('terra_ingot').texture("kubejs:item/terra_ingot").displayName('Terrasteel Ingot').tooltip("§7Once cast, it melds and re-shapes to hold it's form.").tooltip("§7It's durability is unmatched.").rarity('rare')
	event.create('terra_sheet').texture("kubejs:item/terra_sheet").displayName('Terrasteel Sheet').rarity('rare')
	event.create('terra_smithing_template').texture("kubejs:item/terra_upgrade_smithing_template").displayName('Terrasteel Forging Template').rarity('rare')
	...
	event.create('cast_mythril_sword_head').texture("kubejs:item/tool_part/cast_mythril_sword_blade").displayName('Cast Mythril Sword Blade')
	event.create('cast_mythril_pickaxe_head').texture("kubejs:item/tool_part/cast_mythril_pickaxe_head").displayName('Cast Mythril Pickaxe Head')
	event.create('cast_mythril_axe_head').texture("kubejs:item/tool_part/cast_mythril_axe_head").displayName('Cast Mythril Axe Head')
	event.create('cast_mythril_shovel_head').texture("kubejs:item/tool_part/cast_mythril_shovel_head").displayName('Cast Mythril Shovel Head')
	event.create('cast_mythril_hoe_head').texture("kubejs:item/tool_part/cast_mythril_hoe_head").displayName('Cast Mythril Hoe Head')
	event.create('partially_forged_mythril_sword_head', 'create:sequenced_assembly').texture("kubejs:item/tool_part/cast_mythril_sword_blade").displayName('Partially Forged Mythril Sword Blade')
	event.create('partially_forged_mythril_pickaxe_head', 'create:sequenced_assembly').texture("kubejs:item/tool_part/cast_mythril_pickaxe_head").displayName('Partially Forged Mythril Pickaxe Head')
	event.create('partially_forged_mythril_axe_head', 'create:sequenced_assembly').texture("kubejs:item/tool_part/cast_mythril_axe_head").displayName('Partially Forged Mythril Axe Head')
	event.create('partially_forged_mythril_shovel_head', 'create:sequenced_assembly').texture("kubejs:item/tool_part/cast_mythril_shovel_head").displayName('Partially Forged Mythril Shovel Head')
	event.create('partially_forged_mythril_hoe_head', 'create:sequenced_assembly').texture("kubejs:item/tool_part/cast_mythril_hoe_head").displayName('Partially Forged Mythril Hoe Head')
